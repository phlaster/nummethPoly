...
# ╔═╡ e7a4efd6-4801-11ee-241d-ab1b07cac9bf
begin
	using CairoMakie
	using LaTeXStrings
end

# ╔═╡ 53deec76-33b5-4c32-9e8a-72c74061f3c1
f1(x) = x^4-x^3-2x^2+3x-3

# ╔═╡ 6812dc4e-fd35-40c0-a614-c68be7de8ec4
d1f1(x) = 4x^3-3x^2-4x+3

# ╔═╡ bbcd2921-e4de-492c-8098-e494a3c7762b
d2f1(x) = 12x^2-6x-4

# ╔═╡ c67c8f1e-0a2c-4668-9c05-ef9ffddd9131
f2(x) = 3ℯ^x-5x-3

# ╔═╡ 2071d453-ec1c-4f9f-a82f-6abef24825db
d1f2(x) = 3ℯ^x-5

# ╔═╡ 9a4ee41e-d21f-4797-be9f-1dbcf0d018d7
d2f2(x) = 3ℯ^x
...
# ╔═╡ 5f485fdc-da80-40f8-8b5e-5b08236c3c37
let
	a1, b1 = 0.5, 3
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "810418db236904da2fc003178b61c7a9da00ed1b"
