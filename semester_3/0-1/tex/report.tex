...
\begin{figure}[H]
    ...
    \label{fig:pic2}
    \includegraphics[width=0.88\linewidth]{pic2}
\end{figure}
...
{\large\bf{IV. Применение алгоритмов к трансцендентной функции (2) на допустимом интервале:}}\\
{\bf МПД:}
\begin{itemize}
    \item $[a, b]=[0.6, 1.5]$;
...
\begin{figure}[H]
    ...
    \label{fig:pic3}
    \includegraphics[width=1\linewidth]{fzero}
\end{figure}
